...
class ADODB_Session {
	...
	*/
	function expireNotify($expire_notify = null) {
		...
		print "_expire_notify=" . $_expire_notify;
		print_r($_expire_notify);
	...
	*/
	function _sessionKey() {
		...
		//print "(ADODB_Session::encryptionKey()=".ADODB_Session::encryptionKey()."<br>";
...
//			ADOConnection::outp( " driver=$driver user=$user pwd=$password db=$database ");
	...
	*/
	function read($key) {
		...
		if (!$conn) {
			print "<br><br>NO CONNECTION<br><br>";
			return '';
		}
	...
	*/
	function destroy($key) {
		...
		print "DELETE FROM $table WHERE $binary sesskey = $qkey";
